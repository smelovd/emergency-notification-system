...
public class NotificationRequestController {
    ...
    public Mono<ResponseEntity<String>> saveNotificationRequest(@RequestPart("message") String message, @RequestPart("file") Mono<FilePart> file) {
...
//                            .pushToDatabaseAndQueue(file, request.getId())
